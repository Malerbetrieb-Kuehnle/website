      ...
      <div className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl">
            ...
            <h3 className={h3}>Datenerfassung auf dieser Website</h3>{" "}
            <h4 className={h4}>
            ...
            <h4 className={h4}>Wie erfassen wir Ihre Daten?</h4>{" "}
            <p className={p}>
            ...
            <h4 className={h4}>Wof&uuml;r nutzen wir Ihre Daten?</h4>{" "}
            <p className={p}>
            ...
            <p className={p}>
              ...
              entnehmen Sie der Datenschutzerkl&auml;rung von IONOS:{" "}
              <a
            ...
            <h3 className={h3}>Empfänger von personenbezogenen Daten</h3>{" "}
            <p className={p}>
            ...
            <h3 className={h3}>Auskunft, Berichtigung und L&ouml;schung</h3>{" "}
            <p className={p}>
            ...
            <h3 className={h3}>SSL- bzw. TLS-Verschl&uuml;sselung</h3>{" "}
            <p className={p}>
            ...
            <h3 className={h3}>Einwilligung mit Usercentrics</h3>{" "}
            <p className={p}>
              Diese Website nutzt die Consent-Technologie von Usercentrics, um
            ...
            <p className={p}>
              ...
              Daten an Usercentrics &uuml;bertragen:
            </p>{" "}
            <ul>
              {" "}
              <li>
            ...
            <p className={p}>
              ...
              um Ihnen die erteilten Einwilligungen bzw. deren Widerruf zuordnen
              zu k&ouml;nnen. Die so erfassten Daten werden gespeichert, bis Sie
              uns zur L&ouml;schung auffordern, das Usercentrics-Cookie selbst
              l&ouml;schen oder der Zweck f&uuml;r die Datenspeicherung
              entf&auml;llt. Zwingende gesetzliche Aufbewahrungspflichten
              bleiben unber&uuml;hrt.
            </p>{" "}
            <p className={p}>
              Das Usercentrics-Banner auf dieser Website wurde mit Hilfe von
              eRecht24 konfiguriert. Das erkennen Sie daran, dass im Banner das
              Logo von eRecht24 auftaucht. Um das eRecht24-Logo im Banner
              auszuspielen, wird eine Verbindung zum Bildserver von eRecht24
              hergestellt. Hierbei wird auch die IP-Adresse &uuml;bertragen, die
              jedoch nur in anonymisierter Form in den Server-Logs gespeichert
              wird. Der Bildserver von eRecht24 befindet sich in Deutschland bei
              einem deutschen Anbieter. Das Banner selbst wird
              ausschlie&szlig;lich von Usercentrics zur Verf&uuml;gung gestellt.
            </p>
            <p className={p}>
              Der Einsatz von Usercentrics erfolgt, um die gesetzlich
              vorgeschriebenen Einwilligungen f&uuml;r den Einsatz bestimmter
              Technologien einzuholen. Rechtsgrundlage hierf&uuml;r ist Art. 6
              Abs. 1 lit. c DSGVO.
            </p>
            <h2 className={h2}>5. Analyse-Tools und Werbung</h2>
            <h3 className={h3}>IONOS WebAnalytics</h3>{" "}
            <p className={p}>
              ...
              mit IONOS k&ouml;nnen u.&nbsp;a. Besucherzahlen und
              &ndash;verhalten (z.&nbsp;B. Anzahl der Seitenaufrufe, Dauer eines
              Webseitenbesuchs, Absprungraten), Besucherquellen (d. h., von
              welcher Seite der Besucher kommt), Besucherstandorte sowie
              technische Daten (Browser- und Betriebssystemversionen) analysiert
              werden. Zu diesem Zweck speichert IONOS insbesondere folgende
              Daten:
            </p>{" "}
            <ul>
              {" "}
            ...
            <p className={p}>
              Die Datenerfassung erfolgt laut IONOS vollst&auml;ndig
              anonymisiert, sodass sie nicht zu einzelnen Personen
              zur&uuml;ckverfolgt werden kann. Cookies werden von IONOS
            ...
            <p className={p}>
              ...
              IONOS WebAnalytics entnehmen Sie der Datenschutzerklaerung von
            ...
            <h2 className={h2}>6. Eigene Dienste</h2>
            <h3 className={h3}>Umgang mit Bewerberdaten</h3>{" "}
            <p className={p}>
            ...
            <h4 className={h4}>Umfang und Zweck der Datenerhebung </h4>{" "}
            <p className={p}>
              ...
              Bewerbungsgespr&auml;chen etc.), soweit dies zur Entscheidung
              &uuml;ber die Begr&uuml;ndung eines
              ...
              &ndash; sofern Sie eine Einwilligung erteilt haben &ndash; Art. 6
            ...
            <h4 className={h4}>Aufbewahrungsdauer der Daten</h4>{" "}
            <p className={p}>
              ...
              lit. f DSGVO) bis zu 6 Monate ab der Beendigung des
              ...
              Falle eines Rechtsstreits. Sofern ersichtlich ist, dass die Daten
              nach Ablauf der 6-Monatsfrist erforderlich sein werden (z.&nbsp;B.
              aufgrund eines drohenden oder anh&auml;ngigen Rechtsstreits),
              findet eine L&ouml;schung erst statt, wenn der Zweck f&uuml;r die
              weitergehende Aufbewahrung entf&auml;llt.
            </p>{" "}
            <p className={p}>
              Eine l&auml;ngere Aufbewahrung kann au&szlig;erdem stattfinden,
              wenn Sie eine entsprechende Einwilligung (Art. 6 Abs. 1 lit. a
              DSGVO) erteilt haben oder wenn gesetzliche Aufbewahrungspflichten
